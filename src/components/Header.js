		...
		<>
			<div className="relative bg-indigo-50 overflow-hidden">
				<div className="max-w-6xl mx-auto">
					<div className="relative z-10 pb-8 bg-indigo-50 sm:pb-16 md:pb-20 lg:max-w-3xl lg:w-full lg:pb-28 xl:pb-32">
						<Navbar />
						<svg
						...
						<main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
							<div className="sm:text-center lg:text-left">
								...
								<p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
									Jouer au foot au city n'a jamais été aussi
									facile
								</p>
								<div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
									...
									<div className="mt-3 sm:mt-0 sm:ml-3">
										<a
											...
											className="w-full flex items-center justify-center px-8 py-1 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-2 md:text-lg md:px-10">
											Register
										</a>
									</div>
								</div>
